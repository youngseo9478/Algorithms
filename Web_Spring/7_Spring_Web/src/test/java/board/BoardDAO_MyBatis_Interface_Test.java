...
import com.my.biz.board.dao.BoardDAO_MyBatis_Interface;
...
public class BoardDAO_MyBatis_Interface_Test {
	BoardService service;
	
	@Before
	public void setUp() throws Exception {
		BoardDAO dao = new BoardDAO_MyBatis_Interface();
	...
	public void boardUpdate() {
		...
		BoardVO vo = service.boardFind(12);
	...
	public void boardDelete() {
		int row = service.boardDelete(12);
