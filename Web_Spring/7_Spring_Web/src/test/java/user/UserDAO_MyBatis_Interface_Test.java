...
public class UserDAO_MyBatis_Interface_Test{
	UserService service;
	...
	//@Test
	public void getUser() {
		System.out.println("getUser(): "+service.getUser("java10"));
	...
	public void update() {
		...
		System.out.println(" update(): "+service.getUser("java10"));
	}
	...
	//@Test	
	public void remove() {
		int row = service.removeUser("java10");
