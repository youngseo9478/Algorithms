...
<body  data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-4" data-genuitec-path="/8_Spring_Web/src/main/webapp/WEB-INF/user/user_view.jsp">
<table width=780 border=0 cellpadding=0 cellspacing=0 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-4" data-genuitec-path="/8_Spring_Web/src/main/webapp/WEB-INF/user/user_view.jsp">
	<tr>
	  <td width="20"></td>
	  <td>
  <!--contents-->
